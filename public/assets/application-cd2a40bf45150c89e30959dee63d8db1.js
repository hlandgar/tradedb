...
(function() {
  jQuery(function() {
    ...
    $('#trade_entries_attributes_0_category').change(function() {
      ...
      if (options) {
        ...
        return $('#trade_entries_attributes_0_tags').show();
      } else {
        $('#trade_entries_attributes_0_tags').empty();
        return $('#trade_entries_attributes_0_tags').hide();
      }
    });
    return $(document).on("nested:fieldAdded", function(event) {
      var cat_id, field, tags_id;
      field = event.field;
